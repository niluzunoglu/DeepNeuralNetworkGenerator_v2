...
<div style='width: 500px;'>
    ...
    <ul>
        ...
        <li><b>Öğrenme Şekli: </b>Ağın ağırlıkları güncelenirken SGD, MBGD veya BGD yaklaşımlarından hangisinin seçileceğini belirtir.</li>
        <li><b>Örnek Girdi Vektörü: </b>Input vector girilebileceği alandır.</li>
        <li><b>Örnek Hedef Çıktı: </b> Girilen Input vectorlerin çıktı veya çıktılarının girilebileceği alandır.</li>
    </ul>
    ...
    <ul>
        ...
        <li><b>Modeli Eğit (İteratif):</b> Ağı adım adım eğitmenizi sağlar. Burada her bir eğitimde forward ve backward propagation işlemlerini, gradyanları, yeni kayıp ve yeni tahmini gözlemleyebilirsiniz.</li>
